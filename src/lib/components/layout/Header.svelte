		...
		<ul class="flex items-center mb-0 list-none nav-left ps-0 gap-x-[14px] gap-y-[9px]">
			...
			<li>
				<a
					...
					id="slim-toggler"
				>
					<i class="uil uil-align-center-alt text-current [&.is-folded]:hidden flex items-center"
					></i>
				</a>
			</li>
		</ul>
											...
											>
												...
												<div class="flex items-center justify-between flex-1">
													<div class="text-start">
														...
														<p class="mb-0 text-xs text-body dark:text-subtitle-dark">1 min ago</p>
													</div>
													<div>
														<span
					...
					<div class="relative" data-te-dropdown-ref>
						...
						>
							...
							<img
								...
								alt="user photo"
							/>
							<span class="hidden xl:block">Guru Jegan1</span>
							<i
						...
						>
							...
							>
								...
								>
									...
									/>
									<figcaption>
										<div class="text-dark dark:text-title-dark mb-0.5 text-sm">Guru Jegan</div>
