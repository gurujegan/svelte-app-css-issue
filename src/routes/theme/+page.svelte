...
>
		...
		>
			<ul class="relative m-0 list-none px-[0.2rem]">
				<li class="relative sub-item-wrapper group open">
					...
					<ul
						class="sub-item !visible m-0 hidden list-none p-0 [&.show]:block scrollbar overflow-y-scroll show"
					>
						<li class="relative">
							<a
								href="index.html"
							...
							<div class="relative" data-te-dropdown-ref>
								...
								>
									...
									>
										...
										>
													...
													>
														...
														<figcaption class="w-full -mt-1 text-start">
															...
															<div class="flex items-center gap-[30px] text-start">
																<span class="ps-0 min-w-[216px] text-body dark:text-subtitle-dark"
																	>Lorem ipsum dolor amet cosec...</span
																>
																<span
																	class="inline-flex items-center justify-center w-4 h-4 text-white rounded-full bg-light dark:text-white/[.87 text-10"
																	>3</span
																>
															</div>
														</figcaption>
											...
											<li class="w-full">
												...
												>
													...
													>
														<div
															class="text-success w-[40px] min-w-[40px] h-[40px] rounded-full relative"
														>
															<span
																class="bg-current absolute content-[''] w-[12px] h-[12px] rounded-full border-2 border-white right-0 bottom-0"
															></span>
														...
														<figcaption class="w-full -mt-1 text-start">
															...
															>
																Product manager
																<span class="text-xs font-normal text-text-success"
																	>2.5 hrs ago</span
																>
															</h1>
															<div class="flex items-center gap-[30px] text-start">
																...
																>
																<span
																	class="inline-flex items-center justify-center w-4 h-4 text-white rounded-full bg-success dark:text-white/[.87 text-10"
																	>3</span
																>
															</div>
														</figcaption>
											...
											<li class="w-full">
												...
												>
													...
													>
														<div
															class="text-warning w-[40px] min-w-[40px] h-[40px] rounded-full relative"
														>
															<span
																class="bg-current absolute content-[''] w-[12px] h-[12px] rounded-full border-2 border-white right-0 bottom-0"
															></span>
														...
														<figcaption class="w-full -mt-1 text-start">
															...
															<div class="flex items-center gap-[30px] text-start">
																...
																>
																<span
																	class="inline-flex items-center justify-center w-4 h-4 text-white rounded-full bg-warning dark:text-white/[.87 text-10"
																	>3</span
																>
															</div>
														</figcaption>
										...
										<a
											class="flex items-center justify-center text-[13px] font-medium bg-normalBG dark:bg-box-dark-up h-[50px] text-light hover:text-primary dark:hover:text-subtitle-dark dark:text-title-dark mx-[-15px] mb-[-15px] rounded-b-6"
											href="#"
										>
											See all messages
										</a>
										...
										>
												...
												>
													...
													>
														...
														<div class="flex items-center justify-between flex-1">
															...
															<div>
																<span
																	class="inline-flex items-center justify-center bg-warning w-1.5 h-1.5 ms-3 rounded-full"
																></span>
															</div>
														</div>
													</div>
														...
														<div class="flex items-center justify-between flex-1">
															<div class="text-start">
																<h1
																	class="flex items-center justify-between mb-0.5 text-[#5a5f7d] dark:text-title-dark text-sm font-normal flex-wrap"
																>
																	<span class="text-primary me-1.5 font-medium">Guru Jegan</span>
																	sent you a message
																</h1>
																<p class="mb-0 text-xs text-body dark:text-subtitle-dark">
																	3 hours ago
															...
															<div>
																<span
																	class="inline-flex items-center justify-center bg-primary w-1.5 h-1.5 ms-3 rounded-full"
																></span>
															</div>
														</div>
													</div>
											...
											<li class="w-full sm:mb-0 mb-[10px]">
												...
												>
													...
													>
														<div
															class="flex items-center justify-center rounded-full w-[30px] h-[30px] bg-secondary/10 text-secondary"
														>
														...
														<div class="flex items-center justify-between flex-1">
															...
															<div>
																<span
																	class="inline-flex items-center justify-center bg-secondary w-1.5 h-1.5 ms-3 rounded-full"
																></span>
															</div>
														</div>
													</div>
											...
											<li class="w-full sm:mb-0 mb-[10px]">
												...
												>
													...
													>
														<div
															class="flex items-center justify-center rounded-full w-[30px] h-[30px] bg-info/10 text-info"
														>
														...
														<div class="flex items-center justify-between flex-1">
															...
															<div>
																<span
																	class="inline-flex items-center justify-center bg-info w-1.5 h-1.5 ms-3 rounded-full"
																></span>
															</div>
														</div>
													</div>
											...
											<li class="w-full sm:mb-0 mb-[10px]">
												...
												>
													...
													>
														<div
															class="flex items-center justify-center rounded-full w-[30px] h-[30px] bg-danger/10 text-danger"
														>
														...
														<div class="flex items-center justify-between flex-1">
															...
															<div>
																<span
																	class="inline-flex items-center justify-center bg-danger w-1.5 h-1.5 ms-3 rounded-full"
																></span>
															</div>
														</div>
													</div>
											...
											<li class="w-full">
												...
												>
													...
													<figcaption>
														...
														<p class="mb-0 text-body dark:text-subtitle-dark text-start">
							...
							<div class="relative" data-te-dropdown-ref>
								...
								>
									...
									<img
										...
										alt="user photo"
									/>
									<span class="hidden xl:block">Guru Jegan</span>
									<i
		...
		<main class="bg-normalBG dark:bg-main-dark">
				...
				<div class="grid grid-cols-12 gap-[25px]">
					<div class="col-span-12">
						<div class="p-[25px] bg-white rounded-10 dark:bg-box-dark">
							<h1 class="mb-0 text-lg text-dark dark:text-subtitle-dark"><slot />Skeleton Page</h1>
						</div>
					</div>
				</div>
			</div>
			...
			<footer class="px-[25px] bg-white dark:bg-box-dark">
				...
				>
					...
					>
						© <span class="current-year">2022</span> <a href="#" class="text-primary">SovWare</a>
					</div>
	...
	>
		<div
			class="animate-spin inline-block w-[50px] h-[50px] border-[3px] border-current border-t-transparent text-primary rounded-full"
			role="status"
			aria-label="loading"
		>
